...
void main()
{
    ...
    fire_stage = clamp(fire_stage, 0, 3);

    // --- Compute texture coordinates for this stage ---
    // Each stage occupies 1/4th of the texture vertically
    vec2 tex_coord = texture_coord;
    tex_coord.x = tex_coord.x*0.25 + fire_stage * 0.25;
